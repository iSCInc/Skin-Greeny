 ...
 * @ingroup Skins
 */
class SkinGreeny extends SkinTemplate {
	/** Using Greeny. */
	var $skinname = 'Greeny', $stylename = 'Greeny',
		$template = 'GreenyTemplate', $useHeadElement = true;
	...
	function setupSkinUserCss( OutputPage $out ) {
		...
		$out->addStyle( 'Greeny/960.css', 'screen' );  
		$out->addStyle( 'Greeny/gmw.css', 'screen' );
	}
}
 ...
 * @ingroup Skins
 */
class GreenyTemplate extends QuickTemplate {
	var $skin;
	/**
	 * Template filter callback for Greeny skin.
		...
		<div class="header container_16">
			...
			<div class="grid_8">
                            <div class="portlet logo" id="p-logo">
                                    <a style="background-image: url(<?php  echo $wgScriptPath."$IP/images/Wiki.png" ?>);" <?php
	...
	<div class="container_16">
		...
		<div id="footer"<?php $this->html('userlangattributes') ?> class="grid_16">
			...
			<div class="grid_4 omega">
				<h5>Links to the farm</h5>
				<div class="pBody">
					<ul>
						<li><a href="http://inc.isc/about.html">About</a></li>
						<li><a href="http://inc.isc/contact.html">Contact us</a></li>
						<li><a href="http://inc.isc/support-policy.html">Support policy</a></li>
					</ul>
				</div>
			</div>
			<div class="clear"></div>
